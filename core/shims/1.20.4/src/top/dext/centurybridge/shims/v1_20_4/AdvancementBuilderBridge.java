...
/**
 * 1.20.4 port of the Advancement Builder bridges. The 1.20.3 codec wave
...
public abstract class AdvancementBuilderBridge {
    ...
    public class_161.class_162 method_701(class_161 parent) {
        class_8779 entry = top.dext.centurybridge.rt.v1_20_4.Trackers.ADVANCEMENT_ENTRIES.get(parent);
        if (entry == null) {
