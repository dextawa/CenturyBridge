...
public abstract class DrawContextNineSliceBridge {
    ...
    public void method_48587(class_2960 texture,
        ...
        // top-left corner
        ctx.method_25290(net.minecraft.class_1921::method_62277, texture, x, y, (float)(u), (float)(v), borderX, borderY, 256, 256);
        // top-right corner
        ctx.method_25290(net.minecraft.class_1921::method_62277, texture, x + width - borderX, y, (float)(u + regionW - borderX), (float)(v), borderX, borderY, 256, 256);
        // bottom-left corner
        ctx.method_25290(net.minecraft.class_1921::method_62277, texture, x, y + height - borderY, (float)(u), (float)(v + regionH - borderY), borderX, borderY, 256, 256);
        // bottom-right corner
        ctx.method_25290(net.minecraft.class_1921::method_62277, texture, x + width - borderX, y + height - borderY, (float)(u + regionW - borderX), (float)(v + regionH - borderY), borderX, borderY, 256, 256);
    ...
    private static void drawRepeated(class_332 ctx, class_2960 texture,
        ...
        for (int ty = 0; ty < destH; ty += srcH) {
            ...
            for (int tx = 0; tx < destW; tx += srcW) {
                ...
                ctx.method_25290(net.minecraft.class_1921::method_62277, texture, destX + tx, destY + ty, (float)(srcU), (float)(srcV), w, h, 256, 256);
            }
        }
    }
}
